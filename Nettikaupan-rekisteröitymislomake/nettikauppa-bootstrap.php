    ...
    <form class="needs-validation" novalidate="" method="post" action="rekisteroidy.php">
      <div class="row g-3">
        ...
        <div class="col-12">
          ...
          <input type="email" class="form-control" id="email" name="email" placeholder="matti@meikalainen.fi" />
          <div class="invalid-feedback">Lisää sähköpostiosoite</div>
        </div>

        <div class="col-sm-7">
          <label for="address" class="form-label">Osoite</label>
          <input type="text" class="form-control" id="address" name="address" placeholder="Akonmäentie 26 A" required="" />
        ...
        <div class="col-sm-5">
          <label for="address2" class="form-label">Asunnonnumero
            <span class="text-body-secondary">(Valinnainen)</span></label>
          <input type="text" class="form-control" id="address2" name="address2" placeholder="46" />
        </div>
      ...
      <div class="col-md-5">
        ...
        <select class="form-select" id="maksutapa" name="maksutapa" required="">
          <option value="">Valitse...</option>
          <option>Sampo</option>
      ...
      <div class="col-sm-12">
        ...
        <textarea type="text" class="form-control" rows="4" id="palaute" name="palaute" placeholder="" value="" required="">
          </textarea>
        <div class="invalid-feedback">Täytä tämä kenttä</div>
      </div>
